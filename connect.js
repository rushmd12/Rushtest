...
CFonts.say("TDS4YOU OFFCIAL", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By RIDZ STORE\nBase: Ori RIDZ STORE\nRecodeBy:RIDZ STORE\ncampuran\nRuning:Panel\n\n\nSc Ini Di Recode RIDZ STORE Kalo Kethauan Jual Murah Sc inI gua Banned Nyawa Lu Jarak Jauh\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
